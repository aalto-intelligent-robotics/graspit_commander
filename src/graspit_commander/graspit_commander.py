...
class GraspitCommander(object): 
    ...
    def clearWorld():
        ...
        try:
            ...
            print "Could not call clearWorld Service"
    ...
    def importGraspableBody(bodyName, pose=None):
        try:
            ...
            print "Service importGraspableBody not found. Trying again"
